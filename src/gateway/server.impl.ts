...
import { ensureManagedLlamaRuntime, stopManagedLlamaRuntime } from "../llama/runtime.js";
...
export async function startGatewayServer(
  ...
  await ensureManagedLlamaRuntime(cfgAtStart);
  ...
  const close = createGatewayCloseHandler({
    bonjourStop,
    tailscaleCleanup,
    stopManagedLlama: stopManagedLlamaRuntime,
    canvasHost,
    canvasHostServer,
    stopChannel,
    pluginServices,
